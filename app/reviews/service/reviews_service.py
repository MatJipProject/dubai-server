...
def create_review_with_restaurant(
    db: Session, user_id: int, item: schemas.ReviewWithRestaurantCreate
):
    """
    ...
    restaurant = restaurant_service.create_restaurant(db, item.restaurant)
